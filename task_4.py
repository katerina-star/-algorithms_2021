...
"""
Мы провели 2 сравнения dict VS ordered dict. Добавление в словарь ключа и значения. В обоих случаях обычный
словарь справился быстрей.
При том, что с версии Python 3.7 dict стал упорядоченным, то никаких преимуществ ordered dict больше не 
имеет. Ниже мы выведем оба словаря и убедимся в их упорядоченности.
"""
