...
if __name__ == '__main__':
    ...
    print(
        f'Профилирование функции revers_1 спомощью timeit: время выполнения функции - {timeit("revers_1(number)", globals=globals())}')
    ...
    print(
        f'Профилирование функции revers_2 спомощью timeit: время выполнения функции - {timeit("revers_2(number)", globals=globals())}')
    ...
    print(
        f'Профилирование функции revers_3 спомощью timeit: время выполнения функции - {timeit("revers_3(number)", globals=globals())}')
    ...
    print(
        f'Профилирование функции my_reverse спомощью timeit: время выполнения функции - {timeit("my_reverse(number)", globals=globals())}')
